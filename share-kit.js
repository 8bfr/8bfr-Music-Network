...
(function(){
  ...
  function buildUrl(opts) {
    ...
    var path = URL_MAP[opts.type];
    if (!path) return location.href;
    return BASE_URL + path + encodeURIComponent(opts.id || '');
  }
