(function () {
  ...
  #backdrop{
    ...
    backdrop-filter:blur(1px);z-index:9990;
  ...
  #carrie{
    width:min(55vw,420px);            /* 👉 BIGGER CARRIE */
    height:auto;
    border-radius:0;
    background:transparent !important; /* no extra box from the element */
    display:block;
    filter:
  ...
  shell.innerHTML = `
    ...
    <nav id="menu" aria-hidden="true">
      ...
      <details class="group"><summary>Tournaments & Games</summary>
        ...
        <a href="trickshot-pool.html">Trickshot</a>
    ...
    <div id="carrieWrap" title="Chat with Carrie (drag or tap)">
      <video id="carrie"
             ...
             muted
             playsinline
             src="assets/videos/carrie_casual_animate_3_1.mp4"></video>
    </div>
  `;
  ...
  function openMenu(){
    ...
    cWrap.classList.add('aside');  // Carrie slides beside the menu
    resetTimer();
  }
  function closeMenu(){
