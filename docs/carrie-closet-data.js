...
item({
  id: "u_eyes_green_right",
  gender: "unisex",
  category: "eyes",
  cat: "eyes",
  slot: "eyes",
  name: "Green Eye Right",
  label: "green",
  coins: 10,
...
// ---- SHOES (unisex, left + right) ----
item({
  id: "u_shoes_sneaker_left",
  gender: "unisex",
  category: "shoes",
  cat: "shoes",
  slot: "shoes",
